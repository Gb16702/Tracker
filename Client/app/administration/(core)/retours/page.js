import AllTestimonials from "../../../components/common/Global/Admin/AllTestimonials";
  ...
  return (
    <>
      ...
      <div className="flex gap-y-4 flex-col">
        <AllTestimonials head={head} testimonials={testimonialsResponse} />
      </div>
    </>
  );
};
