import AllSubjects from "../../../components/common/Global/Admin/AllSubjects";
...
const page = async () => {
  ...
  const urls = [
    ...
    `${process.env.DEV_API_URL}/sujets`,
  ];
  ...
  return (
    <>
      ...
      <div className="flex gap-y-4 flex-col">
        ...
        <AllSubjects subjects={subjectsResponse} head={head} />
      </div>
    </>
  );
};
